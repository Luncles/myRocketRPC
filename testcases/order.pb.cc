...
constexpr makeOrderResponse::makeOrderResponse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : returninfo_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
const uint32_t TableStruct_order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::makeOrderResponse, returncode_),
  PROTOBUF_FIELD_OFFSET(::makeOrderResponse, returninfo_),
  PROTOBUF_FIELD_OFFSET(::makeOrderResponse, orderid_),
};
...
const char descriptor_table_protodef_order_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ce\030\001 \001(\005\022\r\n\005goods\030\002 \001(\t\"L\n\021makeOrderResp"
  "onse\022\022\n\nreturnCode\030\001 \001(\005\022\022\n\nreturnInfo\030\002"
  " \001(\t\022\017\n\007orderID\030\003 \001(\t2;\n\005Order\0222\n\tmakeOr"
  "der\022\021.makeOrderRequest\032\022.makeOrderRespon"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_order_2eproto = {
  false, false, 215, descriptor_table_protodef_order_2eproto, "order.proto", 
...
makeOrderResponse::makeOrderResponse(const makeOrderResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  returninfo_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    returninfo_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_returninfo().empty()) {
    returninfo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_returninfo(), 
      GetArenaForAllocation());
  }
...
inline void makeOrderResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  returninfo_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_returninfo();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "makeOrderResponse.returnInfo"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "makeOrderResponse.orderID"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* makeOrderResponse::_InternalSerialize(
  ...
  // int32 returnCode = 1;
  if (this->_internal_returncode() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_returncode(), target);
  }

  // string returnInfo = 2;
  if (!this->_internal_returninfo().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_returninfo().data(), static_cast<int>(this->_internal_returninfo().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "makeOrderResponse.returnInfo");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_returninfo(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:makeOrderResponse)
  ...
  // int32 returnCode = 1;
  if (this->_internal_returncode() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_returncode());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:makeOrderResponse)
  ...
  if (!from._internal_returninfo().empty()) {
    _internal_set_returninfo(from._internal_returninfo());
  }
  if (!from._internal_orderid().empty()) {
    _internal_set_orderid(from._internal_orderid());
  }
  if (from._internal_returncode() != 0) {
...
void makeOrderResponse::InternalSwap(makeOrderResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &returninfo_, lhs_arena,
      &other->returninfo_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &orderid_, lhs_arena,
