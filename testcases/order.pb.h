...
class makeOrderResponse final :
 ...
 public:
  ...
  enum : int {
    kReturnInfoFieldNumber = 2,
    kOrderIDFieldNumber = 3,
    kReturnCodeFieldNumber = 1,
  };
  // string returnInfo = 2;
  void clear_returninfo();
  const std::string& returninfo() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_returninfo(ArgT0&& arg0, ArgT... args);
  std::string* mutable_returninfo();
  PROTOBUF_NODISCARD std::string* release_returninfo();
  void set_allocated_returninfo(std::string* returninfo);
  private:
  const std::string& _internal_returninfo() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_returninfo(const std::string& value);
  std::string* _internal_mutable_returninfo();
  public:
  ...
  int32_t returncode() const;
  void set_returncode(int32_t value);
  private:
  int32_t _internal_returncode() const;
  void _internal_set_returncode(int32_t value);
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr returninfo_;
...
// int32 returnCode = 1;
inline void makeOrderResponse::clear_returncode() {
  returncode_ = 0;
}
inline int32_t makeOrderResponse::_internal_returncode() const {
  return returncode_;
}
inline int32_t makeOrderResponse::returncode() const {
  // @@protoc_insertion_point(field_get:makeOrderResponse.returnCode)
  return _internal_returncode();
}
inline void makeOrderResponse::_internal_set_returncode(int32_t value) {
  
  returncode_ = value;
}
inline void makeOrderResponse::set_returncode(int32_t value) {
  _internal_set_returncode(value);
  // @@protoc_insertion_point(field_set:makeOrderResponse.returnCode)
}

// string returnInfo = 2;
inline void makeOrderResponse::clear_returninfo() {
  returninfo_.ClearToEmpty();
}
inline const std::string& makeOrderResponse::returninfo() const {
  // @@protoc_insertion_point(field_get:makeOrderResponse.returnInfo)
  return _internal_returninfo();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void makeOrderResponse::set_returninfo(ArgT0&& arg0, ArgT... args) {
 
 returninfo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:makeOrderResponse.returnInfo)
}
inline std::string* makeOrderResponse::mutable_returninfo() {
  std::string* _s = _internal_mutable_returninfo();
  // @@protoc_insertion_point(field_mutable:makeOrderResponse.returnInfo)
  return _s;
}
inline const std::string& makeOrderResponse::_internal_returninfo() const {
  return returninfo_.Get();
}
inline void makeOrderResponse::_internal_set_returninfo(const std::string& value) {
  
  returninfo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* makeOrderResponse::_internal_mutable_returninfo() {
  
  return returninfo_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* makeOrderResponse::release_returninfo() {
  // @@protoc_insertion_point(field_release:makeOrderResponse.returnInfo)
  return returninfo_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void makeOrderResponse::set_allocated_returninfo(std::string* returninfo) {
  if (returninfo != nullptr) {
    
  } else {
    
  }
  returninfo_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), returninfo,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (returninfo_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    returninfo_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:makeOrderResponse.returnInfo)
}

// string orderID = 3;
inline void makeOrderResponse::clear_orderid() {
  orderid_.ClearToEmpty();
}
inline const std::string& makeOrderResponse::orderid() const {
  // @@protoc_insertion_point(field_get:makeOrderResponse.orderID)
  return _internal_orderid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void makeOrderResponse::set_orderid(ArgT0&& arg0, ArgT... args) {
 ...
 orderid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:makeOrderResponse.orderID)
}
inline std::string* makeOrderResponse::mutable_orderid() {
  std::string* _s = _internal_mutable_orderid();
  // @@protoc_insertion_point(field_mutable:makeOrderResponse.orderID)
  return _s;
}
inline const std::string& makeOrderResponse::_internal_orderid() const {
  return orderid_.Get();
}
inline void makeOrderResponse::_internal_set_orderid(const std::string& value) {
  
  orderid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* makeOrderResponse::_internal_mutable_orderid() {
  
  return orderid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* makeOrderResponse::release_orderid() {
  // @@protoc_insertion_point(field_release:makeOrderResponse.orderID)
  return orderid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void makeOrderResponse::set_allocated_orderid(std::string* orderid) {
  if (orderid != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:makeOrderResponse.orderID)
}
